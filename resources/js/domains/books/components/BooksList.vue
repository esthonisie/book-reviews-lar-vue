...
const booksSortedByTitle = defineModel('booksSortedByTitle');
const booksSortedByAuthor = defineModel('booksSortedByAuthor');
...
<template>
  <div  class="main-container">
    ...
    <template v-for="book in booksSortedByAuthor" :key="book.id">
    <div class="book-container">
    ...
    <template v-else>
    <template v-for="book in booksSortedByTitle" :key="book.id">
    <div class="book-container">
      <p class="title">{{ book.title }}</p>
      <p class="written-by">written by:</p>
      <p class="author">{{ book.author.name }}</p>
